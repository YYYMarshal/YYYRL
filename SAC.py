...
def train(args: Args):
    ...
    agent = SACContinuous(state_dim, args.hidden_dim, action_dim, action_bound,
                          args.actor_lr, args.critic_lr, args.alpha_lr,
                          target_entropy, args.tau, args.gamma, device)
